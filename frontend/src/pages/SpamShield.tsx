      ...
      <main className="pt-32 pb-24 px-6 max-w-6xl mx-auto">
        ...
        <section className="mb-32">
          <div className="text-center mb-16">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">Our NLP engine scans incoming messages in real-time to preserve your active contact quota.</p>
          </div>
