    ...
    <div className="flex-1 space-y-4 p-4 pt-6 md:p-8 animate-in fade-in duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8 border-b border-border pb-6">
        <div>
          ...
          <p className="text-muted-foreground text-sm">Configure how AI intercepts conversations, replies to comments, and manages conditional playbooks across your Instagram account.</p>
        </div>
                ...
                <div className="bg-card border border-border rounded-2xl p-6 lg:p-8 shadow-sm">
                  <div className="flex items-center justify-between mb-10 pb-6 border-b border-border">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mt-1 font-medium">Design the chronological steps AI uses to evaluate leads.</p>
                    </div>
                    <div className="flex items-center gap-4">
                      ...
                      <button 
                        ...
                        className="flex items-center gap-2 text-xs font-bold text-primary-foreground bg-primary px-4 py-2.5 rounded-lg shadow-sm hover:bg-primary/90 transition-colors"
                      >
                  ...
                  <div className="relative pl-16 space-y-10 py-2">
                    {playbookSteps.map((step, idx) => {
                      ...
                      let iconBg = "bg-violet-100 text-foreground border-primary/20";
                        ...
                        <div key={step.id} className="relative group/node">
                          ...
                          <div className="bg-card border border-border rounded-xl p-5 hover:border-violet-300 transition-all shadow-sm relative group">
                            <div className="flex justify-between items-start mb-3">
                              ...
                              <button onClick={() => deleteStep(step.id)} className="text-muted-foreground hover:text-destructive p-1 opacity-0 group-hover:opacity-100 transition-opacity">
                                <Trash2 size={16} />
                              </button>
                            </div>
                            <input 
                  ...
                  <div className="mt-12 pt-6 border-t border-border flex flex-wrap gap-3 items-center justify-between">
                    <div className="flex gap-2">
                      ...
                      <button onClick={() => addPlaybookStep('action')} className="px-3 py-1.5 bg-primary/10 hover:bg-violet-100 text-foreground border border-primary/20 rounded-md text-xs font-bold transition-colors">
                        + Action
                      </button>
                      <button onClick={() => addPlaybookStep('delay')} className="px-3 py-1.5 bg-secondary hover:bg-secondary text-muted-foreground border border-border rounded-md text-xs font-bold transition-colors">
                        + Delay
                      </button>
                    </div>
              ...
              <div className="space-y-6">
                <div className="bg-gradient-to-br from-violet-600 to-indigo-700 rounded-2xl shadow-md p-6 text-primary-foreground relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <h4 className="font-bold flex items-center gap-2 mb-3 text-primary-foreground text-lg">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              <div className="lg:col-span-2 space-y-8">
                ...
                <div className="bg-card border border-border rounded-2xl p-6 shadow-sm">
                  ...
                  <p className="text-sm text-muted-foreground mb-6 font-medium">Map post comments directly to AI-driven DM workflows.</p>

                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mb-5">
                    <div>
                      <label className="text-xs font-bold text-muted-foreground uppercase tracking-wider block mb-2">Target Post</label>
                      <select 
                        value={newPostTitle}
                    ...
                    <div>
                      <label className="text-xs font-bold text-muted-foreground uppercase tracking-wider block mb-2">Trigger Keyword</label>
                      <input 
                        type="text" 
                        value={newKeyword}
                  ...
                  <div className="mb-6">
                    <label className="text-xs font-bold text-muted-foreground uppercase tracking-wider block mb-2">Automated DM Payload</label>
                    <textarea 
                ...
                <div className="border bg-card text-card-foreground shadow-sm rounded-xl overflow-hidden">
                  ...
                  <div className="divide-y divide-zinc-100">
                    {commentTriggers.length === 0 ? (
                      <div className="p-12 text-center text-muted-foreground text-sm">No triggers configured yet.</div>
                      ...
                      <div key={trigger.id} className="p-6 hover:bg-muted transition-colors flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div className="space-y-2 max-w-xl">
                          <div className="flex items-center gap-3">
                            <span className="text-[10px] font-bold uppercase tracking-wider px-2 py-1 bg-violet-100 text-foreground rounded border border-primary/20">
                              IF: {trigger.keyword}
                            </span>
                          ...
                          <p className="text-sm text-muted-foreground font-medium truncate">
                            <span className="text-muted-foreground font-bold mr-1">THEN:</span> {trigger.replyMessage}
                          </p>
                        </div>
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <button onClick={() => setConfirmDeleteId(trigger.id)} className="text-muted-foreground hover:text-destructive transition-colors p-1">
                            <Trash2 size={16} />
                          </button>
                        </div>
                      </div>
                ...
                <div className="bg-card border border-border rounded-2xl p-6 shadow-sm">
                  <div className="flex justify-between items-start mb-6">
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm">The first message sent to net-new inbound conversations.</p>
                    </div>
                  </div>
                  ...
                  <div className="relative">
                    ...
                    />
                    <div className="absolute bottom-3 right-4 text-[10px] font-bold text-muted-foreground bg-card px-2 py-0.5 rounded border border-border">
                  ...
                  <div className="space-y-6">
                    <div className="flex justify-between items-center">
                      <div>
                        ...
                        <p className="text-[11px] text-muted-foreground font-medium">Inject latency to simulate human response times.</p>
                      </div>
              ...
              <div className="space-y-6">
                <div className="bg-card border border-border rounded-2xl p-6 shadow-sm h-[500px] flex flex-col">
                  <h4 className="text-sm font-bold text-foreground mb-6 flex justify-between items-center">
                    Simulated Output <span className="text-[10px] bg-secondary text-muted-foreground px-2 py-1 rounded">PREVIEW</span>
                  </h4>
                  ...
                  <div className="flex-grow flex flex-col gap-4 overflow-y-auto pr-2">
                    <div className="flex flex-col items-start w-full">
                      ...
                      <span className="text-[10px] text-muted-foreground mt-1 ml-1 font-medium">Customer • 12:01 PM</span>
                    </div>
                    
                    <div className="flex flex-col items-end w-full mt-2">
                      <div className="bg-blue-500 text-primary-foreground px-4 py-2.5 rounded-2xl rounded-br-sm text-[13px] font-medium max-w-[85%] shadow-sm whitespace-pre-wrap">
                        {welcomeMessage || 'Your message will render exactly like this.'}
                      </div>
                      <span className="text-[10px] text-muted-foreground mt-1 mr-1 font-medium">AI Agent • 12:01 PM</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-6">
              ...
              <div className="bg-card border border-border rounded-2xl p-6 shadow-sm flex flex-col">
                <div className="flex items-center gap-3 mb-6">
                  <div className="p-2 bg-violet-100 text-foreground rounded-lg">
                    <Bot size={20} />
                  </div>
                  <div>
                    <h3 className="font-bold text-foreground">AI Routing Engine</h3>
                    <p className="text-[11px] text-muted-foreground font-medium">Core inference settings</p>
                  </div>
                </div>
                ...
                <div className="space-y-5 flex-grow">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-[11px] text-muted-foreground">Allow AI to answer unmapped queries</p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-[11px] text-muted-foreground">Ping dashboard when AI stops</p>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
              ...
              <div className="bg-card border border-border rounded-2xl p-6 shadow-sm flex flex-col">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-muted-foreground font-medium">Automatic unread follow-ups</p>
                  </div>
                </div>
              ...
              <div className="bg-card border border-border rounded-2xl p-6 shadow-sm flex flex-col">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-muted-foreground font-medium">Engage brand advocates</p>
                  </div>
                </div>
              ...
              <div className="bg-card border border-border rounded-2xl p-6 shadow-sm flex flex-col">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-muted-foreground font-medium">Manage expectations during downtime</p>
                  </div>
                </div>
