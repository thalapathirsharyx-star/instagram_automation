...
const VerifyEmail: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-[#09090B] font-inter relative overflow-hidden">
      ...
      <div className="w-full max-w-md px-6 relative z-10 animate-in fade-in zoom-in duration-700">
        <div className="bg-primary/60 backdrop-blur-xl border border-zinc-200 rounded-3xl p-8 shadow-2xl text-center">
          ...
          {status === 'loading' && (
            <div className="flex flex-col items-center justify-center py-6">
              <div className="relative flex items-center justify-center mb-6">
                <div className="absolute w-16 h-16 bg-brand/10 rounded-full animate-ping" />
                <Loader2 className="w-10 h-10 text-brand animate-spin relative" />
              </div>
              <h2 className="text-xl font-bold text-zinc-100 mb-2">Verifying your email</h2>
              <p className="text-zinc-500 text-sm">Securing your Flazly dashboard...</p>
            </div>
          )}
          ...
          {status === 'success' && (
            <div className="flex flex-col items-center justify-center py-4">
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 py-3 bg-brand hover:bg-brand text-zinc-900 rounded-xl font-bold transition-all shadow-lg shadow-purple-600/20"
              >
                Continue to Login
          ...
          {status === 'error' && (
            <div className="flex flex-col items-center justify-center py-4">
              <div className="w-16 h-16 bg-danger/10 rounded-full flex items-center justify-center border border-red-500/20 mb-6">
              ...
              <button
                ...
                className="w-full py-3 bg-primary/90 hover:bg-zinc-700 text-zinc-200 rounded-xl font-bold transition-all border border-zinc-200"
              >
                Back to Sign Up
              </button>
            </div>
