      ...
      <AnimatePresence mode="popLayout">
        {toasts.map((t) => (
          <motion.div
            ...
            className="w-full pointer-events-auto bg-white/90 dark:bg-[#09090B]/90 border border-slate-200/60 dark:border-zinc-200 backdrop-blur-xl rounded-2xl p-4 shadow-[0_10px_30px_rgba(0,0,0,0.08)] dark:shadow-[0_15px_40px_rgba(0,0,0,0.4)] flex items-start gap-3 relative overflow-hidden"
          >
            ...
            <div className="flex-grow pr-4">
              ...
              {t.description && (
                <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1 font-medium leading-normal">
                  {t.description}
                </p>
              )}
            </div>
            ...
            <button
              ...
              className="absolute top-3 right-3 text-zinc-500 hover:text-slate-600 dark:text-zinc-500 dark:hover:text-zinc-300 transition-colors p-1 rounded-lg hover:bg-slate-100 dark:hover:bg-zinc-800"
            >
              <X size={14} />
            </button>
          </motion.div>
