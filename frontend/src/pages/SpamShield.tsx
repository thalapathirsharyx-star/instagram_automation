    ...
    <div className="min-h-screen bg-zinc-50 text-zinc-900 font-inter relative overflow-hidden">
      ...
      <main className="pt-32 pb-24 px-6 max-w-6xl mx-auto">
        ...
        <section className="text-center max-w-4xl mx-auto mb-32 relative">
          ...
          >
            Protect Your Inbox from the <span className="text-warning">Noise</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <a href="https://app.flazly.com/signup" className="bg-warning hover:bg-warning text-black px-8 py-4 text-base font-bold rounded-xl shadow-[0_0_40px_rgba(245,158,11,0.4)] transition-all">
              Enable Spam Shield
            </a>
          </motion.div>
        </section>
        ...
        <section className="mb-32">
          <div className="text-center mb-16">
            ...
            <p className="text-zinc-500 text-lg max-w-2xl mx-auto">Our NLP engine scans incoming messages in real-time to preserve your active contact quota.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 relative">
            ...
            {[
              { title: "1. Scan", desc: "Flazly instantly evaluates message length, context, and vocabulary.", icon: <Bot size={24} className="text-warning" /> },
              { title: "2. Analyze", desc: "The AI compares the intent against known buying heuristics.", icon: <TrendingUp size={24} className="text-warning" /> },
              { title: "3. Filter", desc: "Low-intent messages are silently muted. Real buyers proceed.", icon: <CheckCircle size={24} className="text-warning" /> }
            ].map((step, i) => (
        ...
        <section className="mb-24">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <a href="https://app.flazly.com/signup" className="text-warning font-bold flex items-center gap-2 hover:gap-3 transition-all text-lg">
                Start Free Trial <span className="text-warning">→</span>
              </a>
            </div>
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-white border border-zinc-200 p-8 rounded-3xl text-center">
                <div className="text-5xl font-extrabold text-warning mb-2">40%</div>
                <div className="text-sm font-bold text-zinc-500 uppercase tracking-wider">Spam Blocked</div>
              </div>
              <div className="bg-white border border-zinc-200 p-8 rounded-3xl text-center">
                <div className="text-5xl font-extrabold text-warning mb-2">15h</div>
